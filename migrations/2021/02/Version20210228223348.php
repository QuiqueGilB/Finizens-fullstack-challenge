 ...
 */
final class Version20210228223348 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE investmentcontext_portfoliomodule_allocation ADD CONSTRAINT FK_7A74C974B96B5643 FOREIGN KEY (portfolio_id) REFERENCES investmentcontext_portfoliomodule_portfolio (id)');
    }
